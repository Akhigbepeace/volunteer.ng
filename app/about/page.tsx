    ...
    <>
      ...
      <div className="bg-tertiary min-h-screen text-secondary">
        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <p className="text-lg leading-relaxed">
            That&apos;s where Volunteer.ng comes in. We&apos;re more than just a
            platform; we&apos;re a community of Africans who&apos;ve decided
            that waiting for change isn&apos;t enough. We understand the
            frustration of wanting to help but not knowing where to start, and
            the struggle organizations face when they need skilled hands but
            can&apos;t find them.
          </p>
          <p className="text-lg leading-relaxed">
